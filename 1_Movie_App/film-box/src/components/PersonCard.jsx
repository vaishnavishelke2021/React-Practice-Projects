...
const PersonCard = ({ t, title }) => {
  ...
  return (
    <Link
      ...
      className="min-w-[200px] sm:min-w-[190px] max-w-[14%] bg-[#1e1e1e] p-2 rounded-[4px] mb-2 hover:scale-[1.07] transition-all duration-200 ease-in-out cursor-pointer hover:shadow-xl"
    >
      <img
