  ...
  return (
    <div>
      ...
      <form onSubmit={submitHandler} className="mt-6 flex flex-col gap-4 pb-10">
        {/* ---------------------------------------name div ----------------------------------------------------- */}
        <div className="w-full flex justify-start space-x-12">
          <label>
            ...
            <input
              className="bg-zinc-700/20 font-light text-[15px] px-3 py-2 mt-2 w-[120%] border-b-[1px] border-white/10 rounded-sm"
              type="firstName"
              name="firstName"
              id="firstName"
        ...
        {/* -------------------------------------------Buttons ----------------------------------------------- */}
        <button className="bg-yellow-500 tracking-normal border-none py-2 px-3 text-[#0d0d20] font-bold mt-10 rounded-sm w-full">
          Create Account
        </button>

        <div className="mt-3 relative">
          <div className="w-full h-[0.8px] bg-white/20 rounded-sm "></div>
          <span className="bg-[#0d0d20] font-thin text-white/30 px-2 text-[16px] absolute bottom-[-9px] left-[45%]">
            or
          </span>
        </div>
