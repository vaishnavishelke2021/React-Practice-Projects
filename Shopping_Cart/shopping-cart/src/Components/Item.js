  ...
  return (
    <div className=" group max-w-[260px] p-4 rounded-xl bg-[#f6f6f6] shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] hover:scale-[1.06] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-all duration-[0.3s] hover:bg-white z-0">
      ...
      <div className="mt-5 flex flex-wrap justify-between">
        ...
        <button className="text-[14px] text-rose py-[3px] px-4 rounded-lg border-[2px] font-medium border-rose cursor-pointer group-hover:bg-rose group-hover:text-[#f6f6f6] transition-all duration-[0.3s]">
          Add to cart
        </button>
      </div>
    </div>
