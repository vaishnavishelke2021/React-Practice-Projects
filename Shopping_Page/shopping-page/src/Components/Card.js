...
function Card() {
  return (
    <div className="w-[23%] group hover:shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] hover:scale-[1.03] hover:bg-slate-50 transition-all duration-300 cursor-pointer p-3 rounded-lg border-2 bg-primary/10">
